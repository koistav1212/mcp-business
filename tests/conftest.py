...
def mock_all_providers_and_tools():
    ...
    original_search_company = SearchCompanyTool.execute
    original_search_web = SearchWebTool.execute
    ...
    async def mock_execute_search_company(self, **kwargs):
        ...
        return await original_search_company(self, **kwargs)

    async def mock_execute_search_web(self, **kwargs):
        ...
        return await original_search_web(self, **kwargs)
    ...
    with patch.object(EntityResolver, "get_candidates", mock_get_candidates), \
         ...
         patch.object(SearchCompanyTool, "execute", mock_execute_search_company), \
         patch.object(SearchWebTool, "execute", mock_execute_search_web):
        yield
